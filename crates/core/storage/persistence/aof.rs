//! AOF (Append-Only File) persistence for Spatio.
//!
//! Provides AOF file management, rewrite logic, command serialization,
//! and the AOFBackend storage wrapper for durability.

use super::super::memory::MemoryBackend;
use crate::config::{DbItem, SetOptions, SyncMode};
...
// ============================================================================
// AOFBackend - Storage wrapper with persistence
// ============================================================================
